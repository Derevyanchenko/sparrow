...
if ( ! function_exists( 'sparrow_setup' ) ) :
	...
	function sparrow_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'menu-1', 'sparrow' ),
		) );
...
function sparrow_scripts() {
	...
	wp_enqueue_style( 'queries-style', get_template_directory_uri() . "/assets/css/media-queries.css" );

	// sctipts


	wp_deregister_script( "jquery" );
	wp_register_script( "jquery", get_template_directory_uri() . "/assets/js/jquery-1.10.2.min.js" );
	wp_enqueue_script( "migrate-script", get_template_directory_uri() . "/assets/js/jquery-migrate-1.2.1.min.js", array("jquery"), "", true );

	wp_enqueue_script( "modernizr-script", get_template_directory_uri() . "/assets/js/modernizr.js", array("jquery"), "", true );


	wp_enqueue_script( 'sparrow-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sparrow-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( "doubletaptogo-script", get_template_directory_uri() . "/assets/js/doubletaptogo.js", array("jquery"), "", true );
	wp_enqueue_script( "flexslider-script", get_template_directory_uri() . "/assets/js/jquery.flexslider.js", array("jquery"), "", true );

	wp_enqueue_script( "init-script", get_template_directory_uri() . "/assets/js/init.js", array("jquery"), "", true );
